...
public class BreadthFirstSearch {
    ...
    public BreadthFirstSearch(int ml_count, int cl_count, int mr_count, int cr_count, boolean side) {
    ...
    public State runAlgorithm() {
        ...
        while(!queue.isEmpty()) {
            ...
            if(!rules.isGoal(current)) {
                ...
                filter();
                System.out.println("Solution size = " + solution.size() + " (Breadth First Search) {\n");
                print();
                System.out.println("}\n");
                return current;
            }
